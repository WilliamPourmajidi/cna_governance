...
def create_telemetry_entry(service_name, data_type, governance_data, timestamps, log_id, csp, error=None,
                           api_response=None):
    """
    ...
    Args:
        ...
        csp (str): Cloud Service Provider (e.g., 'AWS').
